...
export default class PaginationWrapper extends PureComponent<PropsType> {
  ...
  render() {
    /* eslint no-unused-vars: [2, {"varsIgnorePattern": "(name)"}] */
    const { atBeginEnd, aroundCurrent, disabled, name, readOnly, showFirstLast,
      showPrevNext, totalPages, value, ...etc } = this.props;
